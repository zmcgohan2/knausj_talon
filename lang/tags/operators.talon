...
do minus equal: user.code_operator_subtraction_assignment()
do plus: user.code_operator_addition()
do plus equal: user.code_operator_addition_assignment()
do times: user.code_operator_multiplication()
do times equal: user.code_operator_multiplication_assignment()
do divide: user.code_operator_division()
do divide equal: user.code_operator_division_assignment()
do mod: user.code_operator_modulo()
do mod equal: user.code_operator_modulo_assignment()
...
do or equal: user.code_operator_bitwise_exclusive_or_equals()
do shift left equal: user.code_operator_bitwise_left_shift_equals()
do shift right equal: user.code_operator_bitwise_right_shift_equals()
