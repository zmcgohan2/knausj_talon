...
view {user.file_manager_directories}: user.file_manager_open_directory(file_manager_directories)
peek {user.file_manager_files}: user.file_manager_open_file(file_manager_files)
